    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Have questions? We're here to help. Get in touch with us through any of our contact channels.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">+233 24 123 4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">support@fofoo.com</p>
                </div>
              </div>
            ...
            {/* Social Media Links */}
            <div className="mt-8">
              <h3 className="font-medium text-gray-800 dark:text-white mb-4">Follow Us</h3>
